			...
			<form action="" id="manage_staff">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<b class="text-muted">Informations personnelles</b>
					...
					<div class="col-md-6">
						...
						<b class="text-muted">Identifiants du système</b>
						<div class="form-group">
							<label class="control-label">Adresse e-mai</label>
				...
				<hr>
				<div class="col-lg-12 d-flex justify-content-center mt-3" style="gap: 15px;">
  <button class="btn text-white" style="background-color: #28a745;">Enregistré</button>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					$('#msg').html("<div class='alert alert-danger'>e-mail existe déjà.</div>");
